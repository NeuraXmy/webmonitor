...
export default{
    ...
    methods:{
        ...
        //返回监控页面
        back(){
            if(sessionStorage.getItem('front') === 'monitorlist') this.$router.push('/monitorlist')
            if(sessionStorage.getItem('front') === 'monitorsManagement') this.$router.push('/monitorsManagement')
            // this.$router.push('/monitorsManagement')
        },
